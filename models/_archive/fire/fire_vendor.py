"""
Vendored from https://github.com/Chuchad/FIRE (MIT license, CVPR 2025)
FIRE: Robust Detection of Diffusion-Generated Images via
Frequency-Guided Reconstruction Error.
File origin: utils/network_utils.py (class/function bodies unchanged).
Only the `__main__` smoke-test block was dropped.
"""
